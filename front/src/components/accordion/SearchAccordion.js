...
const SearchAccordion = ({ setSearchModal, handleMinMaxPrice }) => {
  ...
  return (
    ...
    (
      <div className="search-modal__art-type">
        ...
        <div className="search-accordion__body">
          <input
          ...
          />
          <label htmlFor="min-price" className="number-input__label">
            <span>Min price</span>
          </label>
          <span className="input-icon">
            ...
            >
              <g clip-path="url(#clip0_17_17468)">
                <path
          ...
          />
          <label htmlFor="max-price" className="number-input__label">
            <span>Max Price</span>
          </label>
          <span className="input-icon">
            <svg
          ...
          <button
            ...
            onClick={() => {
              ...
              handleMinMaxPrice(minValue, maxValue);
            }}
          >
            GO
          </button>
